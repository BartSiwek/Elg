...
{
    public class TangentComponent : IVertexComponent
    {
        public TangentComponent()
        {
            m_data_[0] = 0.0f;
            m_data_[1] = 0.0f;
            m_data_[2] = 0.0f;
        ...
        public TangentComponent(float x, float y, float z)
        {
            m_data_[0] = x;
            m_data_[1] = y;
            m_data_[2] = z;
        ...
        public TangentComponent(float[] coords)
        {
