...
class AssetManager {
 public:
  // Constructors
  AssetManager(const AssetDescriptor* asset_descriptors, elg_uint32 asset_descriptor_count);

  // Destructor
  ~AssetManager();

  // Methods, including static methods
  template<typename AssetType> Asset<AssetManager<AssetManagerDescription>, AssetType> Get(elg_uint32 id_hash);
 ...
 private:
  ...
  // Methods, including static methods
  template<typename AssetType> AssetType* GetData(elg_uint32 internal_id);
