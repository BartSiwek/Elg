...
ComponentPool<ComponentType, MaxInstances, MaxEntities>::ComponentPool()
  ...
  for (elg_uint32 entity_id_index = 0;entity_id_index < MaxEntities;++entity_id_index) {
  ...
  for (elg_uint32 instance_index = 0;instance_index < MaxInstances;++instance_index) {
...
ComponentPool<ComponentType, MaxInstances, MaxEntities>::~ComponentPool() {
  ...
  for (elg_uint32 instance_index = 0;instance_index < m_top_;++instance_index) {
...
template<typename ComponentType, elg_uint16 MaxInstances, elg_uint16 MaxEntities>
elg_uint32 ComponentPool<ComponentType, MaxInstances, MaxEntities>::CreateComponent(elg_uint32 entity_id_index,
                                                                                elg_uint32 entity_id) {
  ...
  elg_uint32 instance_index = m_top_++;
...
template<typename ComponentType, elg_uint16 MaxInstances, elg_uint16 MaxEntities>
inline elg_uint32 ComponentPool<ComponentType, MaxInstances, MaxEntities>::GetComponent(
    elg_uint32 entity_id_index) const {
  // Just return
  return m_entity_ids_[entity_id_index];
}

template<typename ComponentType, elg_uint16 MaxInstances, elg_uint16 MaxEntities>
void ComponentPool<ComponentType, MaxInstances, MaxEntities>::DestroyComponent(elg_uint32 entity_id_index) {
  // Get the instance index (1xREAD) - we assume that the existence of a component was externaly checked
  elg_uint32 instance_index = m_entity_ids_[entity_id_index];

  // Get the pointer to the top
  elg_uint32 top_instance_index = --m_top_;

  // Get top entity index and generation (1xREAD)
  elg_uint32 top_entity_id = m_active_entity_ids_[top_instance_index];
  elg_uint32 top_entity_id_index = ELG_ENTITY_MANAGER_UNWRAP_ID(top_entity_id);
...
template<typename ComponentType, elg_uint16 MaxInstances, elg_uint16 MaxEntities>
inline elg_uint32 ComponentPool<ComponentType, MaxInstances, MaxEntities>::GetDataCount() const {
  return m_top_;
}

template<typename ComponentType, elg_uint16 MaxInstances, elg_uint16 MaxEntities>
inline const elg_uint32* ComponentPool<ComponentType, MaxInstances, MaxEntities>::GetDataEntities() const {
...
template<typename ComponentType, elg_uint16 MaxInstances, elg_uint16 MaxEntities>
inline ComponentType* ComponentPool<ComponentType, MaxInstances, MaxEntities>::GetStorage(elg_uint32 index) {
...
template<typename ComponentType, elg_uint16 MaxInstances, elg_uint16 MaxEntities>
inline const ComponentType* ComponentPool<ComponentType, MaxInstances, MaxEntities>::GetStorage(
    elg_uint32 index) const {
  ASSERT(index < MaxInstances, "Attempt to access storage with invalid index");
