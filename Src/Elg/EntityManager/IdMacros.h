...
#define ELG_ENTITY_MANAGER_INVALID_ID static_cast<elg_uint32>(0xFFFF)

// We use 16 bits for valid id values, however we reserve the max one as invalid marker
#define ELG_ENTITY_MANAGER_INVALID_GENERATION static_cast<elg_uint32>(0xFFFF)

// Composition of the two above
#define ELG_ENTITY_MANAGER_INVALID_WRAPPED_ID static_cast<elg_uint32>(0xFFFFFFFF)
