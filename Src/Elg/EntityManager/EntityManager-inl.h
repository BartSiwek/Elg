...
template<typename EntityManagerDescriptionType>
inline elg_uint32 EntityManager<EntityManagerDescriptionType>::CreateEntity() {
...
template<typename EntityManagerDescriptionType>
inline elg_uint32 EntityManager<EntityManagerDescriptionType>::GetActiveEntityCount() const {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
...
template<typename EntityManagerDescriptionType>
inline const elg_uint32* EntityManager<EntityManagerDescriptionType>::GetActiveEntities() const {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
...
template<typename EntityManagerDescriptionType>
inline bool EntityManager<EntityManagerDescriptionType>::IsEntityActive(elg_uint32 entity_id) const {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
...
template<typename EntityManagerDescriptionType>
inline void EntityManager<EntityManagerDescriptionType>::DestroyEntity(elg_uint32 entity_id) {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;

  elg_uint32 entity_id_index = m_description_.EntityPool.GetEntityIndex(entity_id);
...
inline elg_uint32 EntityManager<EntityManagerDescriptionType>::CreateComponent(elg_uint32 entity_id) {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
...
template<typename EntityManagerDescriptionType> template<typename T>
inline elg_uint32 EntityManager<EntityManagerDescriptionType>::GetComponent(elg_uint32 entity_id) const {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
  ...
  elg_uint32 offset = m_description_.GetComponentPool<ComponentPoolIndex>().GetComponent(entity_id_index);
...
template<typename EntityManagerDescriptionType> template<typename T>
inline bool EntityManager<EntityManagerDescriptionType>::HasComponent(elg_uint32 entity_id) const {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
...
template<typename EntityManagerDescriptionType> template<typename T>
inline void EntityManager<EntityManagerDescriptionType>::DestroyComponent(elg_uint32 entity_id) {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
...
template<typename EntityManagerDescriptionType> template<typename T>
inline elg_uint32 EntityManager<EntityManagerDescriptionType>::GetDataCount() const {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
...
template<typename EntityManagerDescriptionType> template<typename T>
inline const elg_uint32* EntityManager<EntityManagerDescriptionType>::GetDataEntities() const {
  ELG_PROFILE_ENTITY_MANAGER_SCOPE;
