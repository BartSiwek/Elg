...
const elg_uint32 FrameStatistics::OLD_FPS_WEIGHT_NUM = 9;
const elg_uint32 FrameStatistics::NEW_FPS_WEIGHT_NUM = 1;
const elg_uint32 FrameStatistics::FPS_WEIGHT_DEN = FrameStatistics::OLD_FPS_WEIGHT_NUM +
                                               FrameStatistics::NEW_FPS_WEIGHT_NUM;
const elg_uint32 FrameStatistics::OLD_MS_WEIGHT_NUM = 95;
const elg_uint32 FrameStatistics::NEW_MS_WEIGHT_NUM = 5;
const elg_uint32 FrameStatistics::MS_WEIGHT_DEN = FrameStatistics::OLD_MS_WEIGHT_NUM +
...
elg_uint32 FrameStatistics::s_frame_counter_ = 0;
...
elg_uint32 FrameStatistics::s_current_fps_ = 0;
elg_uint32 FrameStatistics::s_avg_fps_ = 0;
...
void FrameStatistics::RegisterFrameTime(Elg::Clock::GameClock::Duration frame_time) {
  ...
  if (s_accumulated_frame_time_ > RESET_INTERVAL) {
    ...
    elg_uint64 frame_count_64bit = static_cast<elg_uint64>(1000000000) *
                                   static_cast<elg_uint64>(1000 * s_frame_counter_);
    s_current_fps_ = static_cast<elg_uint32>(frame_count_64bit / s_accumulated_frame_time_.Count());
...
elg_uint32 FrameStatistics::GetCurrentFrameTime() {
  return static_cast<elg_uint32>(Elg::Clock::DurationCast<Elg::Clock::Microseconds>(s_current_frame_time_).Count());
}

elg_uint32 FrameStatistics::GetAvgFrameTime() {
  return static_cast<elg_uint32>(Elg::Clock::DurationCast<Elg::Clock::Microseconds>(s_avg_frame_time_).Count());
}

elg_uint32 FrameStatistics::GetCurrentFps() {
  return s_current_fps_;
}

elg_uint32 FrameStatistics::GetAvgFps() {
  return s_avg_fps_;
}
