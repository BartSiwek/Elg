...
#else
#define ASSERT(condition, format, ...) ELG_STATIC_ANALYSIS_ASSUME(condition)
#define VERIFY_TRUE(condition, format, ...) (condition); ELG_STATIC_ANALYSIS_ASSUME(condition)
#define VERIFY_FALSE(condition, format, ...) (condition); ELG_STATIC_ANALYSIS_ASSUME(condition)
#endif
