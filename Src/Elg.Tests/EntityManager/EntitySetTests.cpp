...
TEST(EntityManager_EntitySet_DefaultConstructor) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(0), set.GetCount());
...
TEST(EntityManager_EntitySet_DefaultConstructorWithEntities) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(3), set.GetCount());

  elg_uint32* entities = set.GetEntities();
  elg_uint32* entities_end = entities + set.GetCount();
...
TEST(EntityManager_EntitySet_Empty) {
  ...
  const elg_uint32* data_entities = my_em->GetDataEntities<Component<0>>();
  elg_uint32 data_count = my_em->GetDataCount<Component<0>>();
...
TEST(EntityManager_EntitySet_WithEntities) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(2), set.GetCount());
...
TEST(EntityManager_EntitySet_CopyConstructor) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(0), set.GetCount());
  CHECK_EQUAL(static_cast<elg_uint32>(3), other_set.GetCount());

  elg_uint32* entities = other_set.GetEntities();
  elg_uint32* entities_end = entities + other_set.GetCount();
  CHECK(std::find(entities, entities_end, e1) != entities_end);
  CHECK(std::find(entities, entities_end, e2) != entities_end);
  CHECK(std::find(entities, entities_end, e3) != entities_end);
...
TEST(EntityManager_EntitySet_AssignmentOperatorSelfAssign) {
  ...
  elg_uint32 created_ids[TestEntityManagerType::MaxEntityCount];
...
TEST(EntityManager_EntitySet_BracketOperator) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(4), set.GetCount());
...
TEST(EntityManager_EntitySet_Filter) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(7), C0_C1_set->GetCount());

  C0_C1_set->Filter<Component<0>>();
  CHECK_EQUAL(static_cast<elg_uint32>(2), C0_C1_set->GetCount());

  elg_uint32* C0_entities = C0_C1_set->GetEntities();
  elg_uint32* C0_entities_end = C0_C1_set->GetEntities() + C0_C1_set->GetCount();
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(0), C0_C1_set->GetCount());

  delete C0_C1_set;

  // C2 Filtering
  TestEntitySetType* C2_C3_set = new TestEntitySetType(my_em);
  CHECK_EQUAL(static_cast<elg_uint32>(7), C2_C3_set->GetCount());

  C2_C3_set->Filter<Component<2>>();
  CHECK_EQUAL(static_cast<elg_uint32>(3), C2_C3_set->GetCount());

  elg_uint32* C2_C3_entities = C2_C3_set->GetEntities();
  elg_uint32* C2_C3_entities_end = C2_C3_set->GetEntities() + C2_C3_set->GetCount();
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(1), C2_C3_set->GetCount());
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(7), C3_C2_set->GetCount());

  C3_C2_set->Filter<Component<3>>();
  CHECK_EQUAL(static_cast<elg_uint32>(1), C3_C2_set->GetCount());

  elg_uint32* C3_C2_entities = C3_C2_set->GetEntities();
  elg_uint32* C3_C2_entities_end = C3_C2_set->GetEntities() + C3_C2_set->GetCount();
