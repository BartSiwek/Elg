...
TEST(EntityManager_DefaultState) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(0), my_em->GetActiveEntityCount());
  CHECK_EQUAL(static_cast<elg_uint32>(0), my_em->GetDataCount<Component<0>>());
  CHECK_EQUAL(static_cast<elg_uint32>(0), my_em->GetDataCount<Component<1>>());
  CHECK_EQUAL(static_cast<elg_uint32>(0), my_em->GetDataCount<Component<2>>());
  CHECK_EQUAL(static_cast<elg_uint32>(0), my_em->GetDataCount<Component<3>>());
...
TEST(EntityManager_CreateEntity_UniqueIds) {
  TestEntityManagerType* my_em = new TestEntityManagerType();
  elg_uint32 entities[TestEntityManagerType::MaxEntityCount];

  for (elg_uint32 count = 0;count < TestEntityManagerType::MaxEntityCount;++count) {
    elg_uint32 new_e = my_em->CreateEntity();
...
TEST(EntityManager_CreateEntity_Active) {
  TestEntityManagerType* my_em = new TestEntityManagerType();
  elg_uint32 e = my_em->CreateEntity();
...
TEST(EntityManager_CreateEntity_NoOverflowAfterDelete) {
  ...
  elg_uint32 index_to_remove = (rand() % TestEntityManagerType::MaxEntityCount);  // NOLINT(runtime/threadsafe_fn)
...
TEST(EntityManager_GetActiveEntityCount) {
  ...
  // Create max possible entities
  for (elg_uint32 i = 0;i < TestEntityManagerType::MaxEntityCount;++i) {
...
TEST(EntityManager_GetActiveEntities) {
  ...
  for (elg_uint32 count = 0;count < TestEntityManagerType::MaxEntityCount;++count) {
    ...
    // Check
    const elg_uint32* active_entities = my_em->GetActiveEntities();
    for (elg_uint32 entity_index = 0;entity_index < count+1;++entity_index) {
      bool found = false;
      for (elg_uint32 active_index = 0;active_index < my_em->GetActiveEntityCount();++active_index) {
  ...
  for (elg_uint32 count = TestEntityManagerType::MaxEntityCount;count > 0;--count) {
    // Delete
    // The rand is thread safe on VS according to MSDN
    elg_uint32 index_to_remove = (rand() % count);  // NOLINT(runtime/threadsafe_fn)
    elg_uint32 id_to_remove = entities[index_to_remove];
...
TEST(EntityManager_DestoryEntity_ComponentsRemoved) {
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(1), my_em->GetDataCount<Component<0>>());
  CHECK_EQUAL(e, my_em->GetDataEntities<Component<0>>()[0]);
  CHECK_EQUAL(static_cast<elg_uint32>(0), my_em->GetDataCount<Component<1>>());
  CHECK_EQUAL(static_cast<elg_uint32>(1), my_em->GetDataCount<Component<2>>());
...
TEST(EntityManager_CreateComponent_DistinctComponents) {
  ...
  // Prepare
  elg_uint32 e1 = my_em->CreateEntity();
  elg_uint32 e2 = my_em->CreateEntity();

  elg_uint32 offset1 = my_em->CreateComponent<Component<0>>(e1);
  elg_uint32 offset2 = my_em->CreateComponent<Component<0>>(e2);
...
TEST(EntityManager_CreateComponent) {
  TestEntityManagerType* my_em = new TestEntityManagerType();
  const elg_uint32* data_entities;
  const elg_uint32* data_entities_end;

  // Preapore the inactive entity
  elg_uint32 e1 = my_em->CreateEntity();
  elg_uint32 e2 = my_em->CreateEntity();
  elg_uint32 e3 = my_em->CreateEntity();
  elg_uint32 e4 = my_em->CreateEntity();
  elg_uint32 e5 = my_em->CreateEntity();
  elg_uint32 e6 = my_em->CreateEntity();
  elg_uint32 e7 = my_em->CreateEntity();
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(1), my_em->GetDataCount<Component<1>>());
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(1), my_em->GetDataCount<Component<3>>());
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(2), my_em->GetDataCount<Component<0>>());
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(2), my_em->GetDataCount<Component<1>>());
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(3), my_em->GetDataCount<Component<1>>());
  data_entities = my_em->GetDataEntities<Component<1>>();
  data_entities_end = my_em->GetDataEntities<Component<1>>() + my_em->GetDataCount<Component<1>>();
  CHECK(std::find(data_entities, data_entities_end, e2) != data_entities_end);
  CHECK(std::find(data_entities, data_entities_end, e5) != data_entities_end);
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(2), my_em->GetDataCount<Component<2>>());
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(3), my_em->GetDataCount<Component<2>>());
  data_entities = my_em->GetDataEntities<Component<2>>();
  data_entities_end = my_em->GetDataEntities<Component<2>>() + my_em->GetDataCount<Component<2>>();
  CHECK(std::find(data_entities, data_entities_end, e3) != data_entities_end);
  CHECK(std::find(data_entities, data_entities_end, e6) != data_entities_end);
  ...
  CHECK_EQUAL(static_cast<elg_uint32>(2), my_em->GetDataCount<Component<3>>());
...
TEST(EntityManager_GetComponent) {
  ...
  elg_uint32 read_offset1 = my_em->GetComponent<Component<0>>(e1);
  CHECK_EQUAL(read_offset1, offset1);

  elg_uint32 read_offset2 = my_em->GetComponent<Component<0>>(e2);
