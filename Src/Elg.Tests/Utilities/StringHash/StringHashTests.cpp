...
TEST(X65599_Runtime) {
  // Declare storage
  const elg_uint32 WORD_LENGTH = 10;
  ...
  for (elg_uint32 i = 0;i < WORD_LENGTH-1;++i) {
  ...
  elg_uint32 test_hash = Elg::Utilities::StringHash::X65599Hash(test_input);
  elg_uint32 other_hash = Elg::Utilities::StringHash::X65599Hash(other_input);
...
TEST(X65599_Preprocessor) {
  ...
  elg_uint32 test_hash = ELG_X65599("Prerocessor_Test", 17);
  elg_uint32 other_hash = ELG_X65599("Other_Prerocessor_Test", 23);
...
TEST(X65599_PreprocessorAndCompileTimeEqual) {
  ...
  elg_uint32 test_hash = ELG_X65599("Preprocessor_Runtime_Test", 26);
  elg_uint32 other_hash = Elg::Utilities::StringHash::X65599Hash("Preprocessor_Runtime_Test");
